...
const RootLayout = ({ children }: RootLayoutProps) => (
  ...
  >
    <body>
      <a
        className="bg-background-100 text-gray-1000 fixed top-3 left-3 z-50 -translate-y-[200%] rounded-md px-3 py-2 text-sm shadow-sm transition-transform focus-visible:translate-y-0"
        href="#nd-page"
      >
        Skip to content
      </a>
